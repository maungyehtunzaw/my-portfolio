import {
  ...
  const resumeData = {
    ...
    skillData:[
      ...
      { skill: 'PHP', logo: 'https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg', percent: 80 },
      { skill: 'Laravel', logo: 'https://upload.wikimedia.org/wikipedia/commons/9/9a/Laravel.svg', percent: 75 },
